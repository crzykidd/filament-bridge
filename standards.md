...
| [handoff-prompt-workflow](https://gitea.crzynet.com/crzynet/homelab-configs/src/branch/main/standards/handoff-prompt-workflow/README.md) | 1.4.0 | 2026-05-28 | `prompts/TEMPLATE.md` and `docs/decisions.md` created. Soft pointer in `CLAUDE.md`. |
