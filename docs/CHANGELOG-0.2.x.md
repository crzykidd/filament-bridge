# Changelog — 0.2.x (archived)

Full release notes for the **0.2.x** series — the foundational releases of
filament-bridge. The main [CHANGELOG.md](../CHANGELOG.md) carries a short
summary of each version with a link back here; this file preserves the complete
Keep-a-Changelog detail.
