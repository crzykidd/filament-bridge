...
Startup sequence:
  ...
  2. Lifespan opens async HTTP clients for both upstream APIs
  3. APScheduler is started with no jobs (auto-sync is OFF by default; Phase 3 adds the cycle)
  4. Health endpoint is available immediately at GET /api/health
